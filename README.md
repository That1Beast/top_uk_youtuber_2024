...
# Data source
1. What data is needed to achieve our objective?
...
2. Where is the data coming from? The data is sourced from Kaggle (an Excel extract), see here to find it.
...
3. What should the dashboard contain based on the requirements provided?
